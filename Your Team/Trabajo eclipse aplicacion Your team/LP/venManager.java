...
public class venManager extends JDialog implements ActionListener {
	/**
	 * Aqui definiremos los diferentes jpanel jtextfield y j combox que queramos
	 */
	 ...
	 * Runnable() { public void run() { try { venCrearEquipo frame = new
	 * venCrearEquipo(this, true); frame.setVisible(true); } catch (Exception e) {
	 * e.printStackTrace(); } } }); }
	 */
	...
	/**
	 * A traves de este switch iremos a los diferentes opciones que queramos hacer
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		case ACTION_COMMAND_SIGUIENTE:
			if (!(txtnombre.getText().equals("") || txtapellido1.getText().equals("")
					|| txtapellido2.getText().equals("") || txtdni.getText().equals("")
					|| txtcontrasenia.getText().equals(""))) {
				try {
					gestor.anadirManager(txtnombre.getText(), txtapellido1.getText(), txtapellido2.getText(),
							txtdni.getText(), (String) combosexo.getSelectedItem(),
							(String) combocalidad.getSelectedItem(), 0, txtcontrasenia.getText());
