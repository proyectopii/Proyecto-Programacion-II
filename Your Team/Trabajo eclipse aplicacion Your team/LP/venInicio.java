...
public class venInicio extends JDialog implements ActionListener, WindowListener {
	/**
	 * Aqui definiremos el jpanel que hemos creado
	 */
	...
	/**
	 * Aqui con el switch iremos a los diferentes metodos que hay
	 */
	...
	/**
	 * A traves de esto nos aseguremos de que salte un mensaje de si quiere salir
	 */

	@Override
	public void windowClosing(WindowEvent e) {
		int r = JOptionPane.showConfirmDialog(this, "¿Estas seguro?", "Salir", JOptionPane.YES_NO_OPTION,
